class AddressesController < ApplicationController
  ...
  def create
    ...
    if @address.save
      redirect_to @address, notice: "The address was added to the system."
    else
      render action: 'new'
    end
  end
  ...
  def destroy
    if @address.destroy
      ...
      redirect_to @address, notice: "This address could not be deleted because it is associated with an existing order so it has been made inactive instead."
    end
  end
